...
def export_to_sheets(event_name, lineups, projected_players,
    ...
    if contest_profile and contest_metrics and contest_params:
        ...
        contest_rows = [
            ...
            ["Max Exposure", contest_params["max_exposure"], "", ""],
            ["Leverage Power", contest_params["leverage_power"], "", ""],
            ["Leverage Floor", contest_params.get("leverage_floor", ""), "", ""],
            ["Leverage Cap", contest_params.get("leverage_cap", ""), "", ""],
